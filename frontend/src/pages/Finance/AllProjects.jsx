...
const AllProjects = () => {
  ...
  const fetchProjects = async () => {
    try {
      setLoading(true)
      setError('')
      const response = await axiosInstance.get(API_PATHS.FINANCE.GET_PROJECTS)
    ...
    <DashboardLayout>
      <div className="max-w-7xl mx-auto p-4 sm:p-6">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-gray-600 text-sm sm:text-base">View all projects assigned to you</p>
        </div>
        ...
        {allProjects.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 sm:p-12 text-center">
            ...
            <p className="text-gray-500 mb-6">You don't have any projects assigned to you yet</p>
          </div>
        ) : projects.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 sm:p-12 text-center">
            <svg
                    ...
                    {projects.map((project) => {
                      ...
                      return (
                        <tr 
                          ...
                          onClick={() => navigate(`/finance/projects/${project._id}`)}
                        >
                          ...
                          <td className="px-6 py-4">
                            <div className="text-sm">
                              <div className="font-medium text-gray-900">{project.programPersonnel?.name || 'N/A'}</div>
                              <div className="text-gray-500">{project.programPersonnel?.email || ''}</div>
                            </div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                ...
                >
                  <div className="space-y-3">
                    ...
                    <div className="pt-2 border-t border-gray-100">
                      <span className="text-xs text-gray-500 block mb-1">Program Personnel</span>
                      <div className="text-sm">
                        <div className="font-medium text-gray-900">{project.programPersonnel?.name || 'N/A'}</div>
                        <div className="text-gray-500 text-xs mt-0.5">{project.programPersonnel?.email || ''}</div>
                      </div>
                    </div>
