  ...
  const fetchRequestDetails = useCallback(async () => {
    try {
      ...
      const response = await axiosInstance.get(
        API_PATHS.ADMIN.GET_REALLOCATION_BY_ID(id)
      );
  ...
  return (
    <DashboardLayout>
      <div className="max-w-7xl mx-auto p-4 sm:p-6">
        {/* Header - Always shows (like UserHistory) */}
        <div className="mb-4 sm:mb-6">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <button
              onClick={() => navigate("/admin/allreallocation")}
        ...
        {/* Error - Same pattern as UserHistory */}
        {error && !loading && (
        ...
        {/* No Request Found - Same pattern as UserHistory */}
        {!request && !loading && !error && (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 sm:p-12 text-center">
            ...
            <p className="text-gray-500 mb-6">
              The requested reallocation could not be found.
            </p>
            <button
              onClick={() => navigate("/admin/allreallocation")}
        ...
        {/* Request Details - Only shows when we have data, not loading, no error */}
        {request && !loading && !error && (
          <>
            {/* Status Cards */}
              ...
              {request.approvedAt && (
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div
                      className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center flex-shrink-0 ml-2 sm:ml-4 ${
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-900">
                    {request.destinationCurrency || "N/A"}
                  </p>
                </div>
                <div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-900 font-semibold">
                      1 {request.sourceCurrency} = {request.exchangeRate}{" "}
                      {request.destinationCurrency}
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-900">
                      {request.exchangeRateDate
                        ? formatDate(request.exchangeRateDate)
                        : "N/A"}
                    </p>
                  </div>
                  <div>
