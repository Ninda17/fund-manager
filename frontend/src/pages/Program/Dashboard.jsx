...
const Dashboard = () => {
  ...
  const getDashboardData = async () => {
    try {
      setLoading(true);
      const response = await axiosInstance.get(API_PATHS.PROGRAM.DASHBOARD_DATA);
  ...
  const recentReallocations = dashboardData?.recentReallocations || [];
  ...
  if (loading) {
    return (
      <DashboardLayout activeMenu="/program/dashboard">
    ...
    <DashboardLayout activeMenu="/program/dashboard">
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="mb-4">
              <h2 className="text-lg font-semibold text-black">Recent Reallocations</h2>
            </div>
            {recentReallocations.length > 0 ? (
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200">
              ...
              <div className="text-center py-8 text-gray-400">No recent reallocations</div>
            )}
          </div>
        </div>
      </div>
